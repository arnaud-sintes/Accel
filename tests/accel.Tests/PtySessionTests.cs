...
#pragma warning restore xUnit1031
    ...
    // ---------------------------------------------------------------------------------------------
    // Reported bug: a session created through Accel never appeared in panel A. Root cause: `claude`
    // inherited CLAUDE_CODE_CHILD_SESSION (and friends) from Accel's own process environment - which
    ...
    // markers unconditionally, since every session Accel launches is meant to be an independent,
    ...
    public void SessionOptionsDefaultToAnEightyByTwentyFiveTerminalWithABoundedOutputChannel()
    {
        ...
        Assert.Null(options.JobObject); // null == AccelJobObject.Shared, resolved at Start
    }
