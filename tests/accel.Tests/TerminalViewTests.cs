...
{
    [Fact]
    public void BuildAttachScript_ProducesTheExpectedAccelAttachPtyCall()
    {
        string script = TerminalView.BuildAttachScript("abc123", 40010);

        Assert.Equal("window.accelAttachPty(\"abc123\", 40010);", script);
    }
    ...
    public void BuildAttachScript_JsonEncodesTabId_SoHostileContentCannotBreakOutOfTheScript(string hostileTabId)
    {
        ...
        string prefix = "window.accelAttachPty(";
        string suffix = ", 12345);";
