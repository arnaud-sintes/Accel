...
/// <see cref="Glaude.Orchestration.PtySession"/> (which would need a live ConPTY/child process) -
/// see <see cref="Glaude.Server.IPtyEndpoint"/>, the seam introduced for exactly this purpose.
/// </summary>
