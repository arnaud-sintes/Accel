...
/// <c>TerminalView.VirtualHostName</c>, <c>"glaude-terminal"</c>, navigated to as
/// <c>https://glaude-terminal/index.html</c>). A browser sends that exact value as the
...
public static class PtyRoutes
{
    ...
    /// ever changes, this literal must be updated to match - <c>"https://" + "glaude-terminal"</c>,
    ...
    /// </summary>
    public const string ExpectedOrigin = "https://glaude-terminal";
