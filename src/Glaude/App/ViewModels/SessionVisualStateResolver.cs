...
public static class SessionVisualStateResolver
{
    ...
    /// <summary>Accent colour: running, focused.</summary>
    public const string RunningFocusedColorHex = "#FF1565C0";

    /// <summary>Accent colour: running, not focused.</summary>
    public const string RunningColorHex = "#FF2E7D32";

    /// <summary>Accent colour: idle, focused.</summary>
    public const string IdleFocusedColorHex = "#FF5C6BC0";

    /// <summary>Accent colour: idle, not focused.</summary>
    public const string IdleColorHex = "#FF757575";
