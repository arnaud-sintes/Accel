namespace Glaude.App.Converters;
...
/// hex colours <see cref="Glaude.Metrics.ModelBadgeTable"/> and
/// <see cref="Glaude.App.ViewModels.SessionVisualStateResolver"/> resolve (plain strings, kept
