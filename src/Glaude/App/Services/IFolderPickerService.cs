...
/// Exists as an interface purely so <see cref="Glaude.App.ViewModels.RootsPanelViewModel"/> is
...
/// <c>Glaude.csproj</c>), so this reuses that rather than hand-rolling a WPF folder picker.
/// </summary>
