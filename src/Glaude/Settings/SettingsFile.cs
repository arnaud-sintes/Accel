...
{
    public const string BackupSuffix = ".glaude.bak";
    ...
    /// <summary>True once the <c>.glaude.bak</c> copy has been taken in this session.</summary>
    ...
    /// <c>.glaude.bak</c> copy of the original before the first write of this session.
    /// </summary>
