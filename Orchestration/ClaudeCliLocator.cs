...
/// consumer from <see cref="Accel.Cli.DoctorCommand"/>'s `ResolveClaude`, which is a
/// diagnostic-only probe run once by `accel doctor`; this class backs an actual process launch.
///
...
///
/// Mirrors <see cref="Accel.Cli.DoctorCommand.ResolveClaude"/>'s PATH-walking semantics: walks
