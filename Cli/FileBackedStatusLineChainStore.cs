...
///
/// <para><b>Location decision:</b> <c>%USERPROFILE%\.claude\accel-state.json</c>, i.e.
...
/// is a natural, discoverable home for Accel's own small amount of state.</para>
///
...
{
    public const string DefaultFileName = "accel-state.json";
    ...
    private void WriteAtomic(JsonObject root)
    {
        ...
        var temp = Path.Combine(directory ?? ".", $".accel-state-{Guid.NewGuid():N}.tmp");
